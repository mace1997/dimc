...
// Sat Sep 14 16:00:49 2024
// from snax_req_handler.cc

`timescale 1ps / 1ps


module snax_req_handler( clk, rst, snax_acc_req_valid, snax_acc_req_data_addr, snax_acc_req_data_wen, snax_acc_req_data_data, snax_acc_req_ready, acc_snax_rsp_valid, acc_snax_rsp_data_data, acc_snax_rsp_ready, alpha_QKV_out_valid, alpha_QKV_out_data, alpha_QKV_out_ready, alpha_QKT_out_valid, alpha_QKT_out_data, alpha_QKT_out_ready, alpha_CONV_out_QKT_valid, alpha_CONV_out_QKT_data, alpha_CONV_out_QKT_ready, alpha_CONV_out_QKV_valid, alpha_CONV_out_QKV_data, alpha_CONV_out_QKV_ready
      , trig_hub_streamer_handler_master_data_in_0, trig_hub_streamer_handler_master_data_in_1, trig_hub_streamer_handler_master_data_in_2, trig_hub_streamer_handler_master_data_in_3, trig_hub_streamer_handler_master_in_cur_write, trig_hub_streamer_handler_master_out_cur_write, trig_hub_qkv_handler_master_data_in_0, trig_hub_qkv_handler_master_data_in_1, trig_hub_qkv_handler_master_data_in_2, trig_hub_qkv_handler_master_data_in_3, trig_hub_qkv_handler_master_data_in_4
    ...
    wire  snax_req_handler_Equal_1U_8_4_37_out1;
    reg [31:0] s_reg_13;
    ...
    always @(posedge clk)
      begin : drive_trig_hub_streamer_handler_master_in_next_write
        if (rst == 1'b0) 
          begin
            // op:trig_hub_streamer_handler_master_gen_in_next_write_1/OP366
            // at: trig_done_lib/c_parts/trig_hub_streamer_handler.h:862:9
            // Call Stack: 
          ...
          begin
            // op:trig_hub_streamer_handler_master_gen_in_next_write_1/OP373
            // at: trig_done_lib/c_parts/trig_hub_streamer_handler.h:868:11
            // Call Stack: 
    ...
    always @(posedge clk)
      begin : drive_trig_hub_qkv_handler_master_in_next_write
        if (rst == 1'b0) 
          begin
            // op:trig_hub_qkv_handler_master_gen_in_next_write_1/OP378
            // at: trig_done_lib/c_parts/trig_hub_qkv_handler.h:870:9
            // Call Stack: 
          ...
          begin
            // op:trig_hub_qkv_handler_master_gen_in_next_write_1/OP385
            // at: trig_done_lib/c_parts/trig_hub_qkv_handler.h:876:11
            // Call Stack: 
    ...
    always @(posedge clk)
      begin : drive_trig_hub_qkt_handler_master_in_next_write
        if (rst == 1'b0) 
          begin
            // op:trig_hub_qkt_handler_master_gen_in_next_write_1/OP390
            // at: trig_done_lib/c_parts/trig_hub_qkt_handler.h:870:9
            // Call Stack: 
          ...
          begin
            // op:trig_hub_qkt_handler_master_gen_in_next_write_1/OP397
            // at: trig_done_lib/c_parts/trig_hub_qkt_handler.h:876:11
            // Call Stack: 
            ...
            if (snax_req_handler_N_Muxb_1_4_13_4_5_out1) 
              begin
                if (snax_req_handler_N_Mux_1_3_15_4_12_out1) 
                  begin
                    ...
                    // in function process_snax_acc_req called from snax_req_handler.cc:220:13
              ...
              begin
                case (s_reg_13) 
                  ...
                  default: 
                    begin
                      if (snax_req_handler_Equal_1U_8_4_37_out1) 
                        begin
              ...
              default: 
                begin
                  case (global_state) 
                    5'd03: 
                      begin
                        if (snax_req_handler_N_Muxb_1_4_13_4_5_out1 && snax_req_handler_Equal_1U_0_4_16_out1) 
                          begin
      ...
      begin : drive_alpha_CONV_out_QKV_valid
        if (rst == 1'b0) 
          begin
            ...
            // at: cynw_blocking_put.h:290:16
            // Call Stack: 
            // in function reset_put called from snax_req_handler.cc:195:28
              ...
              default: 
                begin
                  case (global_state) 
                    5'd03: 
                      begin
                        if (snax_req_handler_N_Muxb_1_4_13_4_5_out1 && snax_req_handler_Equal_1U_1_4_15_out1) 
                          begin
              ...
              default: 
                begin
                  case (global_state) 
                    5'd03: 
                      begin
                        if (snax_req_handler_N_Muxb_1_4_13_4_5_out1 && snax_req_handler_Equal_1U_10_4_6_out1) 
                          begin
      ...
      begin : drive_alpha_QKV_out_valid
        if (rst == 1'b0) 
          begin
            ...
            // at: cynw_blocking_put.h:290:16
            // Call Stack: 
            // in function reset_put called from snax_req_handler.cc:193:23
                      ...
                      begin
                        if (snax_acc_req_valid) 
                          begin
                            ...
                            // at: cynw_blocking_put.h:269:21
                            // Call Stack: 
                            // in function put called from snax_req_handler.cc:183:18
                            // in function send_rsp called from snax_req_handler.cc:216:13
      ...
      begin : drive_acc_snax_rsp_valid
        if (rst == 1'b0) 
          begin
            ...
            // at: cynw_blocking_put.h:290:16
            // Call Stack: 
            // in function reset_put called from snax_req_handler.cc:192:22
      ...
      begin : drive_snax_acc_req_ready
        if (rst == 1'b0) 
          begin
            ...
            // at: cynw_blocking_get.h:318:16
            // Call Stack: 
            // in function reset_get called from snax_req_handler.cc:191:22
      ...
      begin : drive_trig_hub_streamer_handler_master_out_last_read
        if (rst == 1'b0) 
          begin
            ...
            // at: trig_done_lib/c_parts/trig_hub_streamer_handler.h:899:2
            // Call Stack: 
            // in function reset called from snax_req_handler.cc:199:42
      ...
      begin : drive_trig_hub_qkt_handler_master_out_last_read
        if (rst == 1'b0) 
          begin
            ...
            // at: trig_done_lib/c_parts/trig_hub_qkt_handler.h:908:2
            // Call Stack: 
            // in function reset called from snax_req_handler.cc:197:37
      ...
      begin : drive_qkv_busy
        if (rst == 1'b0) 
          begin
            ...
            // at: snax_req_handler.cc:201:9
            // Call Stack: 
            // in function f_snax_req_handler called from snax_req_handler.cc:201:9
            qkv_busy <= 1'd0;
          end 
        else 
          begin
      ...
      begin : drive_streamer_busy
        if (rst == 1'b0) 
          begin
            ...
            // at: snax_req_handler.cc:203:9
            // Call Stack: 
            // in function f_snax_req_handler called from snax_req_handler.cc:203:9
            streamer_busy <= 1'd0;
          end 
        else 
          begin
                      ...
                      begin
                        if (snax_acc_req_valid) 
                          begin
                            ...
                            // in function get called from cynw_blocking_get.h:307:8
                            s_reg_13 <= snax_acc_req_data_addr;
                          end 
                      end
                  endcase
                end
    ...
    // at: snax_req_handler.cc:220:34
    assign snax_req_handler_Equal_1U_10_4_6_out1 = s_reg_13 == 32'd0000000006;
    ...
    // Implements 3 operation(s)
    // at: snax_req_handler.cc:220:34
    assign snax_req_handler_Equal_1U_1_4_15_out1 = s_reg_13 == 32'd0000000007;
    ...
    // Implements 1 operation(s)
    // at: snax_req_handler.cc:220:34
    assign snax_req_handler_NotEQ_1U_5_4_9_out1 = s_reg_13 != 32'd0000000006;
    ...
    // Implements 1 operation(s)
    // at: snax_req_handler.cc:220:34
    assign snax_req_handler_NotEQ_1U_12_4_13_out1 = s_reg_13 != 32'd0000000007;
    ...
    // at: snax_req_handler.cc:220:34
    assign snax_req_handler_Equal_1U_0_4_16_out1 = s_reg_13 == 32'd0000000008;
    
    // rtl_instance:snax_req_handler/snax_req_handler_Equal_1U_8_4_37
    // Resource=snax_req_handler_Equal_1U_8_4, Function=eq : Inputs=32 Outputs=1
    // Implements 20 operation(s)
    // at: snax_req_handler.cc:220:34
    assign snax_req_handler_Equal_1U_8_4_37_out1 = s_reg_13 == 32'd0000000005;
    ...
    //    FSM: global_state == 2
    // BB12 : PROTO_4
    //   SRCLOC: snax_req_handler.cc:218:13
    //    FSM: global_state == 3
    // BB31 : PROTO_15
    ...
    //    FSM: global_state == 7
    // BB159 : PROTO_30
    //   SRCLOC: snax_req_handler.cc:223:9
    //    FSM: global_state == 29
              ...
              if (snax_req_handler_N_Muxb_1_4_13_4_5_out1) 
                begin
                  case (s_reg_13) 
                    ...
                    default: 
                      begin
                        // basic_block:f_snax_req_handler/BB159
                ...
                begin
                  case (s_reg_13) 
                    ...
                    32'd0000000003: 
                      begin
                        // basic_block:f_snax_req_handler/BB51
          ...
          5'd19: 
            begin
              if (alpha_CONV_out_QKT_ready) 
                ...
                begin
                  // basic_block:f_snax_req_handler/BB65
